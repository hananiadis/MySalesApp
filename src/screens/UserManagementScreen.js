...
const FIELD_STRINGS = {
  ...
  lastName: '\u0395\u03c0\u03ce\u03bd\u03c5\u03bc\u03bf',
  email: 'Email',
  invalidEmailTitle: '\u039b\u03ac\u03b8\u03bf\u03c2 email',
  invalidEmailMessage: '\u0395\u03b9\u03c3\u03ac\u03b3\u03b5\u03c4\u03b5 \u03ad\u03b3\u03ba\u03c5\u03c1\u03bf email.',
...
const UserManagementScreen = ({ navigation }) => {
  ...
  }, [closeEditor, draftBrands, draftEmail, draftFirstName, draftLastName, draftRole, manageableBrandSet, selectedUser, users]);
  ...
  const toggleBrand = useCallback((brand) => {
    if (!manageableBrandSet.has(brand)) return;
    setDraftBrands((prev) => {
      const base = prev.filter((value) => manageableBrandSet.has(value));
      if (base.includes(brand)) {
        return base.filter((value) => value !== brand);
      }
      return [...base, brand];
    });
  }, [manageableBrandSet]);
