...
export const SPREADSHEETS = {
  ...
  sales2025: {
    ...
    type: 'csv',
    ttlHours: 720, // Archive: refresh monthly (past year)
    permanent: true,
  },
  orders2025: {
  ...
  sales2026: {
    key: 'sheet_playmobil_sales_2026',
    url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTaILJrtA4JwLGO1RWuzXZpbytYf_XX1rL8VYM8ZXNUw3_JBM8gE3ozVOxmIoJox8iJXqdERKg4kS6m/pub?gid=616087206&single=true&output=csv',
    type: 'csv',
    ttlHours: 12,
    permanent: false,
  },
  orders2026: {
    key: 'sheet_playmobil_orders_2026',
    url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTaILJrtA4JwLGO1RWuzXZpbytYf_XX1rL8VYM8ZXNUw3_JBM8gE3ozVOxmIoJox8iJXqdERKg4kS6m/pub?gid=724538995&single=true&output=csv',
    type: 'csv',
    ttlHours: 12,
    permanent: false,
  },
  balance2026: {
    key: 'sheet_playmobil_balance_2026',
    url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTaILJrtA4JwLGO1RWuzXZpbytYf_XX1rL8VYM8ZXNUw3_JBM8gE3ozVOxmIoJox8iJXqdERKg4kS6m/pub?gid=440325138&single=true&output=csv',
    type: 'csv',
    ttlHours: 12,
    permanent: false,
  },
  sales2024: {
    ...
    type: 'csv',
    ttlHours: 12,
    permanent: true, // Past year sheet: download once unless forced
  },
  orders2024: {
  ...
  // Note: sheet_playmobil_orders_2025/2024 unused placeholders with incomplete gids have been removed.
  ...
  kivosSales2025: {
    ...
    type: 'csv',
    ttlHours: 168, // Archive: refresh weekly (past year)
    permanent: true,
    keepColumns: [0, 1, 2, 3, 4], // Date, DocType, CustomerCode, CustomerName, TotalAmount
  },
  kivosSales2026: {
    key: 'sheet_kivos_sales_2026',
    url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vShBCA6wNFKvorlOigErsopBn9dW2YYrlvA2fa27iUpJOeoWjeMIHXS9MgNtrNUZhwYVgZ8rjOfEHeG/pub?gid=1583044875&single=true&output=csv',
    type: 'csv',
